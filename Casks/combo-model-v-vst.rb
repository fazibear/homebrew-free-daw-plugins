cask "combo-model-v-vst" do
  version "latest"
  sha256 :no_check
  url "https://alt1.plugins4free.com/get_plug/ComboV_133_VST.zip"
  name "Combo Model V"
  ...
  depends_on :macos
  artifact "ComboV_133_VST", target: "#{Dir.home}/Library/Audio/Plug-Ins/VST"
end
